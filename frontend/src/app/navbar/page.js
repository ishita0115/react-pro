                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center">
                        <div className="flex-shrink-0">
                            <Link href="/">
                                <img className="h-10 mt-2" src="/images/logo.png" alt="homespere" />
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center justify-center flex-1 space-x-4">
                        ...
                        <NavLink href="/map">Services</NavLink>
                        <NavLink href="/signin-login">Contact us</NavLink>
                        <NavLink href="/profile">Property</NavLink>
                    </div>
                    {/* Signin and Login */}
                ...
                {isMenuOpen && (
                    <div className="md:hidden">
                        <div className="px-2 pt-2 pb-3 space-y-1">
                            ...
                            <MobileNavLink href="/signin-login"> Contact us</MobileNavLink>
                            <MobileNavLink href="/profile">Property</MobileNavLink>
                        </div>
                    </div>
                )}
            </div>
...
const NavLink = ({ href, children }) => {
    return (
        <Link href={href}>
            <div className="text-black uppercase hover:text-blue-500 px-2 py-1 rounded-md cursor-pointer">{children}</div>
        </Link>
    );
};
const MobileNavLink = ({ href, children }) => {
    return (
        <Link href={href}>
            <div className="block text-black hover:text-blue-500 px-3 py-2 rounded-md cursor-pointer">{children}</div>
        </Link>
    );
};
